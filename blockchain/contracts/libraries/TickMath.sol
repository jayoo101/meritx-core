...
/// @dev Forked from Uniswap v3-core (commit ed88be3) with Solidity 0.8.x compatibility:
///      - pragma updated to >=0.8.0
///      - unchecked blocks added to preserve original wrapping arithmetic behavior
///      - All magic constants and logic are identical to the audited Uniswap V3 original
library TickMath {
